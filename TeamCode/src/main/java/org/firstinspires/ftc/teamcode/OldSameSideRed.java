...
@Disabled
@Autonomous (name="OldSameSideRed", group="Qualifier")
public class OldSameSideRed extends LinearOpMode {
    //Hardware
    ...
    public void runOpMode() {
        ...
        /*
        Log.d("OldSameSideRed", "About to move the stick Elbow ");
        //Color Sensor and Smacker
        robotControl.moveStickElbow(0.25);
        sleep(200);
        Log.d("OldSameSideRed", "About to move the stick shoulder ");
        ...
        while (opModeIsActive() && runtime.seconds() <= 10) {
            ...
            if (distanceDouble < 50) {
                if (sensorControl.isRed()) {
                    ...
                    Log.d("OldSameSideRed", "Seeing Red ");
                ...
                else if (sensorControl.isBlue())
                {
                    ...
                    Log.d("OldSameSideRed", "Seeing Blue ");
            ...
            else
            {
                ...
                Log.d("OldSameSideRed", "Still moving smacker... Distance sensed is: " + distanceDouble);
            }
        ...
        */
        ...
        if (vuMark.equalsIgnoreCase("CENTER"))
        {
            ...
            distanceToRightWall = 112; //this is 124 cm
        }
        else if (vuMark.equalsIgnoreCase("RIGHT"))
        {
            backwardsDistance = -32; //this is 32 inches
            distanceToRightWall = 96; //this is 108 cm
        }
        else
        {
            backwardsDistance = -48; //this is 48 inches
            distanceToRightWall = 128; //this is 140 cm
        }
        ...
        while (arrivedAtAngle == false && runtime.seconds() < 6)
        {
            ...
            Log.d("OldSameSideRed", "First Angle is: " + angles.firstAngle);

            if (angles.firstAngle < (angle + marginOfError) && angles.firstAngle > (angle - marginOfError))
            {
                arrivedAtAngle = true;
                Log.d("OldSameSideRed", "Reached angle  " + angles.firstAngle);
                Log.d("OldSameSideRed", "Arrived at Angle?: " + arrivedAtAngle);
            }
            ...
            if(arrivedAtAngle == false)
            {
                ...
                if (angles.firstAngle < angle) {
                    ...
                    Log.d("OldSameSideRed", "Turned Left ");
                } else if (angles.firstAngle > angle) {
                    robotControl.turnRight(TURN_SPEED);
                    Log.d("OldSameSideRed", "Turned Right ");
                } else {
        ...
        telemetry.update();
        Log.d("OldSameSideRed", "Turned the desired angle ");
        ...
        telemetry.update();
        Log.d("OldSameSideRed", "Robot Status: " + "About to align with cyrptobox");
        Log.d("OldSameSideRed", "distanceToLeftWall is  " + distanceToRightWall);
        Log.d("OldSameSideRed", "distanceMarginOfError is  " + distanceMarginOfError);
        ...
        while(alignedWithCryptobox == false && runtime.seconds() < 6)
        {
            ...
            Log.d("OldSameSideRed", "distance is " + distance);
            ...
            if(distance < distanceToRightWall + distanceMarginOfError && distance > distanceToRightWall - distanceMarginOfError)
            {
                ...
                telemetry.update();
                Log.d("OldSameSideRed", "Status:  Alligned" );
            ...
            else
            {
                ...
                telemetry.update();
                Log.d("OldSameSideRed", "Status:  Not Alligned :(");
                ...
                if(distance > 100)
                {
                    ...
                    if(distance > distanceToRightWall)
                    {
                        while(sideWaysTime.seconds() < 0.1)
                        {
                            ...
                            telemetry.update();
                            Log.d("OldSameSideRed", "Status:  Moving left");
                        }
                    ...
                    else
                    {
                        while(sideWaysTime.seconds() < 0.1)
                        {
                            ...
                            telemetry.update();
                            Log.d("OldSameSideRed", "Status:  Moving right");
                        }
                    }
                }
            }
