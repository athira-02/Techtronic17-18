...
@Disabled
@Autonomous (name="OldDifferentSideRed", group="Qualifier")
public class OldDifferentSideRed extends LinearOpMode {
    //Hardware
    ...
    public void runOpMode() {
        ...
        if (vuMark.equalsIgnoreCase("CENTER"))
        {
            ...
            distanceToRightWall = 68; //this is 124 cm
        }
        else if (vuMark.equalsIgnoreCase("LEFT"))
        {

            distanceToRightWall = 84; //this is 108 cm
        }
        else
        {

            distanceToRightWall = 52; //this is 140 cm
        }
        ...
        while (arrivedAtAngle == false && runtime.seconds() < 10)
        {
            ...
            Log.d("OldDifferentSideRed", "First Angle is: " + angles.firstAngle);

            if (angles.firstAngle < (angle + marginOfError) && angles.firstAngle > (angle - marginOfError))
            {
                arrivedAtAngle = true;
               Log.d("OldDifferentSideRed", "Reached angle  " + angles.firstAngle);
               Log.d("OldDifferentSideRed", "Arrived at Angle?: " + arrivedAtAngle);
            }
            ...
            if(arrivedAtAngle == false)
            {
                ...
                if(angles.firstAngle >=0)
                {
                    if (angles.firstAngle < angle) {
                        ...
                        Log.d("OldDifferentSideRed", "Turned Left ");
                    } else if (angles.firstAngle > angle) {
                        robotControl.turnRight(TURN_SPEED);
                        Log.d("OldDifferentSideRed", "Turned Right ");
                    } else {
       ...
       //Side ways align with the correct column of the cryptobox
        ...
        telemetry.update();
        Log.d("OldDifferentSideRed", "Robot Status: " + "About to align with cyrptobox");
        Log.d("OldDifferentSideRed", "distanceToRightWall is  " + distanceToRightWall);
        Log.d("OldDifferentSideRed", "distanceMarginOfError is  " + distanceMarginOfError);
        ...
        while(alignedWithCryptobox == false && runtime.seconds() < 6)
        {
            ...
            Log.d("OldDifferentSideRed", "distance is " + distance);
            ...
            if(distance < distanceToRightWall + distanceMarginOfError && distance > distanceToRightWall - distanceMarginOfError)
            {
                ...
                telemetry.update();
                Log.d("OldDifferentSideRed", "Status:  Alligned" );
            ...
            else
            {
                ...
                telemetry.update();
                Log.d("OldDifferentSideRed", "Status:  Not Alligned :(");
                ...
                if(distance < distanceToRightWall)
                {
                    ...
                    telemetry.update();
                    Log.d("OldDifferentSideRed", "Status:  Moving left");
                ...
                else
                {
                    ...
                    telemetry.update();
                    Log.d("OldDifferentSideRed", "Status:  Moving right");
                }
            }
