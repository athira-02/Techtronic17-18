...
/**
 * The is the autonomous program for the Same Side Red corner of the playing field
 * Same Side Red means that it is on the RED ALLIANCE and the cryptobox and jewel set
 * are located on the same side of the playing field
 * Created by Athira.
 */

@Autonomous (name="SameSideRed", group="Qualifier")
public class SameSideRed extends LinearOpMode {
    //Hardware
    ...
    public void runOpMode() {
        ...
        //Grab the glyph and lift the arm up
     ...
     * color jewel.
     * This ensures that unless we are 100% sure of smacker the correct jewel, we do not smack any jewel
     */
    public void smacker()
    {
    ...
    public void vuMarkAndSetParameters()
    {
        ...
        if (vuMark.equalsIgnoreCase("CENTER"))
        {
            ...
            distanceToRightWall = 96; //this is 112 cm
        }
        else if (vuMark.equalsIgnoreCase("RIGHT"))
        {
            backwardsDistance = -32; //this is 32 inches
            distanceToRightWall = 80; //this is 96 cm
        }
        else
        {
            backwardsDistance = -44; //this is 48 inches
            distanceToRightWall = 109; //this is 128 cm
        }
    }
    ...
    public void turn90(double maxSeconds)
    {
        ...
        while (arrivedAtAngle == false && runtime.seconds() < maxSeconds)
        {
            ...
            Log.d("SameSideRed", "First Angle is: " + angles.firstAngle);

            if (angles.firstAngle < (angle + marginOfError) && angles.firstAngle > (angle - marginOfError))
            {
                arrivedAtAngle = true;
                Log.d("SameSideRed", "Reached angle  " + angles.firstAngle);
                Log.d("SameSideRed", "Arrived at Angle?: " + arrivedAtAngle);
            }
            ...
            if(arrivedAtAngle == false)
            {
                ...
                if (angles.firstAngle < angle)
                {
                    ...
                    Log.d("SameSideRed", "Turned Left ");
                }
                else if (angles.firstAngle > angle)
                {
                    robotControl.turnRight(speed);
                    Log.d("SameSideRed", "Turned Right ");
                }
                else
                {
                    robotControl.stopMoving();
        ...
        telemetry.update();
        Log.d("SameSideRed", "Turned the desired angle " + angles.firstAngle);
    }
    ...
    /**
     *  This method is used to align with the correct column of the crytobox.  It utilizes the
    ...
    public void sideWaysAlign()
    {
        ...
        telemetry.update();
        Log.d("SameSideRed", "Robot Status: " + "About to align with cyrptobox");
        Log.d("SameSideRed", "distanceToLeftWall is  " + distanceToRightWall);
        Log.d("SameSideRed", "distanceMarginOfError is  " + distanceMarginOfError);
        ...
        while(alignedWithCryptobox == false && runtime.seconds() < 4)
        {
            ...
            Log.d("SameSideRed", "distance is " + distance);
            ...
            */
            ...
            if(distance < distanceToRightWall + distanceMarginOfError && distance > distanceToRightWall - distanceMarginOfError)
            {
                ...
                telemetry.update();
                Log.d("SameSideRed", "Status:  Alligned" );
            ...
            else
            {
                ...
                telemetry.update();
                Log.d("SameSideRed", "Status:  Not Alligned :(");
                ...
                if(distance > 100)
                {
                    ...
                    if(distance > distanceToRightWall)
                    {
                        while(sideWaysTime.seconds() < 0.1)
                        {
                            ...
                            telemetry.update();
                            Log.d("SameSideRed", "Status:  Moving right");
                        }
                    ...
                    else
                    {
                        while(sideWaysTime.seconds() < 0.1)
                        {
                            ...
                            telemetry.update();
                            Log.d("SameSideRed", "Status:  Moving left");
                        }
                    }
                }
            }
