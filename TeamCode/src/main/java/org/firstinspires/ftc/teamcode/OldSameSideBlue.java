...
@Disabled
@Autonomous (name="OldSameSideBlue", group="Qualifier")
public class OldSameSideBlue extends LinearOpMode {
    //Hardware
    ...
    public void runOpMode() {
        ...
        /*
        Log.d("OldSameSideBlue", "About to move the stick Elbow ");
        //Color Sensor and Smacker
        robotControl.moveStickElbow(0.25);
        sleep(200);
        Log.d("OldSameSideBlue", "About to move the stick shoulder ");
        robotControl.moveStickShoulder(0.5);

        double elbowPosition = 0.5;
        double shoulderPosition = 0.5;
        String distance;
        double distanceDouble;

        runtime.reset();
        while (opModeIsActive() && runtime.seconds() <= 10) {
            distance = sensorControl.getDistance(DistanceUnit.CM);
            distanceDouble = Double.parseDouble(distance);
            telemetry.addData("distance: ", distance);
            telemetry.update();

            if (distanceDouble < 50) {
                if (sensorControl.isRed()) {
                    telemetry.addData("I see Red!!", "Ready to smack RIGHT");
                    telemetry.update();

                    Log.d("OldSameSideBlue", "Seeing Red ");
                ...
                else if (sensorControl.isBlue())
                {
                    telemetry.addData("I see Blue!", "Ready to smack LEFT");
                    telemetry.update();

                    Log.d("OldSameSideBlue", "Seeing Blue ");
                ...
                {
                    telemetry.addData("I have arrived", "But I can't identify the color;");
            ...
            {
                if (elbowPosition <= 0.6)
                {
                    robotControl.moveStickShoulder(shoulderPosition);
                    robotControl.moveStickElbow(elbowPosition);
                }
                else
                {
                    robotControl.moveStickShoulder(shoulderPosition);
                ...
                Log.d("OldSameSideBlue", "Still moving smacker... Distance sensed is: " + distanceDouble);
            }
        ...
        //Ensure that the smacker goes back up
        robotControl.stickUp();
        */
        ...
        {
            forwardDistance = 40; //this is 40 inches
            distanceToLeftWall = 121; //this is 124 cm
        }
        else if (vuMark.equalsIgnoreCase("LEFT"))
        {
            forwardDistance = 32; //this is 32 inches
            distanceToLeftWall = 108; //this is 108 cm
        }
        else
        {
            forwardDistance = 48; //this is 48 inches
            distanceToLeftWall = 150; //this is 140 cm
        }
        ...
        while (arrivedAtAngle == false && runtime.seconds() < 6)
        {
            ...
            Log.d("OldSameSideBlue", "First Angle is: " + angles.firstAngle);

            if (angles.firstAngle < (angle + marginOfError) && angles.firstAngle > (angle - marginOfError))
            {
               arrivedAtAngle = true;
               Log.d("OldSameSideBlue", "Reached angle  " + angles.firstAngle);
               Log.d("OldSameSideBlue", "Arrived at Angle?: " + arrivedAtAngle);
            }
            ...
            if(arrivedAtAngle == false)
            {
                ...
                if (angles.firstAngle < angle) {
                    ...
                    Log.d("OldSameSideBlue", "Turned Left ");
                } else if (angles.firstAngle > angle) {
                    robotControl.turnRight(TURN_SPEED);
                    Log.d("OldSameSideBlue", "Turned Right ");
                } else {
        ...
        telemetry.update();
        Log.d("OldSameSideBlue", "Turned the desired angle ");
        ...
        telemetry.update();
        Log.d("OldSameSideBlue", "Robot Status: " + "About to align with cyrptobox");
        Log.d("OldSameSideBlue", "distanceToLeftWall is  " + distanceToLeftWall);
        Log.d("OldSameSideBlue", "distanceMarginOfError is  " + distanceMarginOfError);
        ...
        while(alignedWithCryptobox == false && runtime.seconds() < 6)
        {
            ...
            Log.d("OldSameSideBlue", "distance is " + distance);
            ...
            if(distance < distanceToLeftWall + distanceMarginOfError && distance > distanceToLeftWall - distanceMarginOfError)
            {
                ...
                telemetry.update();
                Log.d("OldSameSideBlue", "Status:  Alligned" );
            ...
            else
            {
                ...
                telemetry.update();
                Log.d("OldSameSideBlue", "Status:  Not Alligned :(");
                ...
                if(distance > 100)
                {
                    ...
                    if(distance > distanceToLeftWall)
                    {
                        while(sideWaysTime.seconds() < 0.1)
                        {
                            ...
                            telemetry.update();
                            Log.d("OldSameSideBlue", "Status:  Moving left");
                        }
                    ...
                    else
                    {
                        while(sideWaysTime.seconds() < 0.1)
                        {
                            ...
                            telemetry.update();
                            Log.d("OldSameSideBlue", "Status:  Moving right");
                        }
                    }
                }
            }
        ...
        runtime.reset();
        //make sure that the angle is 90 degrees
        while (arrivedAtAngle == false && runtime.seconds() < 4)
        {
            telemetry.addData("angles.firstAngle is :", angles.firstAngle);
            Log.d("OldSameSideBlue", "First Angle is: " + angles.firstAngle);
