...
@Disabled
@Autonomous
public class AutoDifferentSideBlue extends LinearOpMode {
...
/*
        ...
        //The steps
        runtime.reset();
        while (opModeIsActive() && runtime.seconds() < moveBackwards1)
        {
            robotControl.moveBackwards(DRIVE_SPEED);  //Moving Backwards off the Balancing Stone
        }
        ...
        while (opModeIsActive() && runtime.seconds() < moveForward1 )
        {
