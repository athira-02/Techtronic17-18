...
/**
 * Created by Athira on 1/12/2018.
 */
@Disabled
@Autonomous (name="BackUpSameSideBlue", group="Qualifier")
public class BackUpSameSideBlue extends LinearOpMode {
    //Hardware
    ...
    public void runOpMode() {
        ...
        sleep(500);
        robotControl.moveStickElbow(0.6);
        sleep(500);
        ...
        while (arrivedAtAngle == false && runtime.seconds() < 6)
        {
            ...
            Log.d("BackupSameSideBlue", "First Angle is: " + angles.firstAngle);

            if (angles.firstAngle < (angle + marginOfError) && angles.firstAngle > (angle - marginOfError))
            {
                arrivedAtAngle = true;
                Log.d("BackupSameSideBlue", "Reached angle  " + angles.firstAngle);
                Log.d("BackupSameSideBlue", "Arrived at Angle?: " + arrivedAtAngle);
            }
            ...
            if(arrivedAtAngle == false)
            {
                ...
                if (angles.firstAngle < angle) {
                    ...
                    Log.d("BackupSameSideBlue", "Turned Left ");
                } else if (angles.firstAngle > angle) {
                    robotControl.turnRight(TURN_SPEED);
                    Log.d("BackupSameSideBlue", "Turned Right ");
                } else {
        ...
        telemetry.update();
        Log.d("BackupSameSideBlue", "Turned the desired angle ");
